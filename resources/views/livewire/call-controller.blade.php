                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row">
                                <label for="total_waiting" class="col-md-6 col-form-label text-xl-center text-info"><h1 class="call-number-label" wire:poll.30000ms.visible>{{ $queues->count() }}</h1></label>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 text-center">
                                    @if ($queue)
                                    <a wire:click="callAgain()" class="btn btn-warning call-btn" href="#">CALL AGAIN</a>
